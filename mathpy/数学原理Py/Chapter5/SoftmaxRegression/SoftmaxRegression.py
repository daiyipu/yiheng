...
class SoftmaxRegression(object):
    ...
    def MBGD(self, alpha, batch_size,lambd = 0):
        """
    ...
    def train_BGD(self, iter, alpha,lambd = 0):
        """
        这是利用BGD算法迭代优化的函数
        :param iter: 迭代次数
        :param alpha: 学习率
        ...
        Cost = []
        # 追加未开始训练的模型训练损失
        Cost.append(np.average(self.Cost()))
        # 开始进行迭代训练
        for i in range(iter):
    ...
    def train_SGD(self, iter, alpha,lambd = 0):
        """
        这是利用SGD算法迭代优化的函数
        :param iter: 迭代次数
        :param alpha: 学习率
    ...
    def train_MBGD(self, iter, batch_size, alpha,lambd = 0):
        """
        这是利用MBGD算法迭代优化的函数
        :param iter: 迭代次数
    ...
    def test(self, Test_Data):
        ...
        for test_data in Test_Data:
            # 预测每组data的结果
            predict_result.append(self.predict(test_data))
